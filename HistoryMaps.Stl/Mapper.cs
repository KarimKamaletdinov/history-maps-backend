...
public static class Mapper
{
    public static StlFile Convert(Area area)
    {
        ...
        for (var longitude = 0; longitude < 361; longitude++)
            for (var latitude = 0; latitude < 181; latitude++)
    ...
    {
        var vertex = new StlVertex(200, 0, 0).RotateZ(latitude / 181 * MathF.PI).RotateY(longitude / 180.5f * MathF.PI);
        return vertex;
    }
}